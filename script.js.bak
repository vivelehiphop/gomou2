...
def directions():
    ...
    # Appeler l'API Google Maps avec les paramètres de l'utilisateur
    ...
    # Créer une liste de coordonnées pour chaque étape du trajet
    coordinates = []
    for step in steps:
    ...
    # Afficher la page avec la carte et le trajet
    return render_template("directions.html", origin=origin, destination=destination, coordinates=coordinates)
